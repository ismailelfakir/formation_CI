...
window.tplMgr = {
	...
	fStrings: ["Enlarge", "Hide some interface elements to enlarge the content",
		...
		/*08*/      "", "Theme",
		/*10*/      "Switch to dark theme", "Switch to light theme",
		/*12*/      "", "Menu",
		/*14*/      "Open the menu", "Close the menu",
	""],
	...
	init: function (pParam) {
		...
		try {
			...
			if (scPaLib.checkNode(".module.emeraude", document.body)){
				this.fStrings[0] = "Close";
				this.fStrings[1] = "Hide the activity menu";
				this.fStrings[2] = "Menu";
				this.fStrings[3] = "Display the activity menu";
